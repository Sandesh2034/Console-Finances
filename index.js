var finances = [
  ...
  function analyzeFinances(data) {
    ...
    var greatestIncreaseIndex = changes.indexOf(greatestIncrease) + 1;
    var greatestDecreaseIndex = changes.indexOf(greatestDecrease) + 1; 
    ...
    var result = {
      ...
      greatestIncrease: {
        date: data[greatestIncreaseIndex][0],
        amount: greatestIncrease.toFixed(2),
      },
      greatestDecrease: {
        date: data[greatestDecreaseIndex][0],
        amount: greatestDecrease.toFixed(2),
      },
    };
  ...
  console.log("Total: $", analysisResult.netTotal.toFixed(2));
